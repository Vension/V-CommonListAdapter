 ...
 * ========================================================
 */
class CommonListViewHolderForKotlin {
     ...
     */
     ...
     fun get(context: Context, convertView: View?, parent: ViewGroup, layoutId: Int): CommonListViewHolderForKotlin {
        return if (convertView == null) {
            CommonListViewHolderForKotlin(context, parent, layoutId)
        } else convertView.tag as CommonListViewHolderForKotlin
    }
     ...
     */
    fun setText(viewid: Int, content: String): CommonListViewHolderForKotlin {
        getTextView(viewid).text = content
        return this
    }

    fun setVisibility(viewid: Int, visibility: Int): CommonListViewHolderForKotlin {
    ...
    fun setCheck(viewid: Int, isChecked: Boolean): CommonListViewHolderForKotlin {
     ...
     */
    fun setImageResource(viewid: Int, resid: Int): CommonListViewHolderForKotlin {
